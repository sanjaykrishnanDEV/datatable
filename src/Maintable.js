...
const columns = [
  ...
  {
    name: "Edit",
    cell: (row) => <button className="bg-red-100 rounded-md p-1">Edit</button>,
  },
  {
    name: "Delete",
    cell: (row) => (
      <button
        className="bg-red-100 rounded-md p-1"
...
function Maintable() {
  ...
  return (
    <div
      ...
      style={{ padding: "30px", backgroundColor: "grey" }}
    >
      <DataTable
        columns={columns}
        data={records}
        ...
        subHeaderComponent={
          <input
            ...
            className="w-1/4 border-2 border-slate-800 rounded-md"
